// Basit Analytics Veri Toplama Fonksiyonu
function collectAnalyticsData() {
    return {
        ...
        behavior: {
            timeOnPage: Math.round((Date.now() - window.pageLoadStartTime) / 1000),
            ...
            formFillTime: 0 // Bu alanı form submission sırasında hesaplayacağız
        },
        timing: {
